...
const ProjectPage = () => {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([entry]) => {
        setAnimate(entry.isIntersecting); // Langsung set kondisi tanpa if-else
      },
      {
        threshold: 0.5,
      }
    ...
    const currentRef = animateRef.current; // Simpan referensi untuk menghindari pengubahan dalam cleanup
